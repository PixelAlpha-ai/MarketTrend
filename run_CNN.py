...
if __name__ == "__main__":
    ...
    # Testing set
    # symbol_testing = 'BTCUSDT'
    # time_frame_testing = '1h'
    # test_folder = f'{path_data}\\data_testing_{symbol_testing}_{time_frame_testing}'
    # test_log = f'dataset_log_{symbol_testing}_{time_frame_testing}_testing.csv'
    ...
    try:
        ...
        for test_symbol in ['BTCUSDT', 'ETHUSDT', 'BNBUSDT', 'DOGEUSDT', 'SOLUSDT', 'NEARUSDT', 'LINKUSDT']:
            for test_timeframe in ['1h']:
                ...
                print(f'Test accuracy for {test_symbol} {test_timeframe}:', score[1])
