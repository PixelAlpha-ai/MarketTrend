...
class TrainingDataGenerator:
    ...
    def generate_dataset(self, path_save, type_data, datetime_start, datetime_end, stride_size=None):
        ...
        path_save_folder = f'{path_save}\\data_{type_data}'
        ...
        for idx_end in range(self.num_candles, dataset.shape[0], interval):
            ...
            name_image_npy = f'{path_save}\\data_{type_data}\\{name_file_prefix}.npy'
...
if __name__ == '__main__':
    ...
    # name_symbol = 'ETHUSDT'
    # name_symbol = 'BNBUSDT'
    # name_symbol = 'DOGEUSDT'
    # name_symbol = 'SOLUSDT'
    # name_symbol = 'NEARUSDT'
    # name_symbol = 'LINKUSDT'
    ...
    image_binary, fig_OHLC = generator.generate_example_image(datetime_end='2022-03-01 00:00:00+00:00')
    fig_OHLC.show()
    fig = go.Figure(data=go.Heatmap(z=image_binary, colorscale='gray'))
    fig.show()

    # Generate the training set
    datetime_start_training = '2020-02-01 00:00:00+00:00'
    datetime_end_training = '2022-03-01 00:00:00+00:00'
...
#
# class TrainingDataGenerator:
#     def __init__(self, path_csv, name_symbol, timeframe, num_candles, num_project_length, num_rows, num_MA, flag_add_MA=False):
#
#         # generate parameters
#         self.datetime_format = '%Y-%m-%d %H:%M:%S+00:00'
#         self.path_csv = path_csv
...
#
#     timeframe = '1h'
#     path_csv = f'data\\{name_symbol}_{timeframe}.csv'
#     path_save = 'C:\\Data'
#     num_candles = 5
#     num_project_length = 40
#     stride_size = 1
#     num_rows = 60
#     num_MA = 20
#
...
#
#     # show one random image
#     image_binary, fig_OHLC = generator.generate_example_image(datetime_end='2020-02-01 00:00:00+00:00')
#     fig_OHLC.show()
#     fig = go.Figure(data=go.Heatmap(z=image_binary, colorscale='gray'))
#     fig.show()
#
...
#     # Generate the testing set
#     datetime_start_testing = '2023-03-01 00:00:00+00:00'
#     datetime_end_testing = '2024-02-01 00:00:00+00:00'
#     df_dataset_log_testing = generator.generate_dataset(type_data='testing',
#                                                         path_save=path_save,
#                                                         datetime_start=datetime_start_testing,
#                                                         datetime_end=datetime_end_testing,
