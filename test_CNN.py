...
# Study 2024-04-27 generate big model using all crypto study
if __name__ == "__main__":
    ...
    model_path = f'{path_data}\\model_{model_name}.h5'
    ...
    results_df.to_csv(f'{path_data}\\results_{model_name}.csv', index=False)
    print(results_df)
